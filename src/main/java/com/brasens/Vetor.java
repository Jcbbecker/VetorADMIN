...
public class Vetor extends Application {
    ...
    public void start(Stage stage) {
        ...
        //Image brasensIcon = new Image(Vetor.class.getResource("/mspm/resources/Icone File.png").toString());
    ...
    public static void openActionPopUp(String title, String text, ActionStatusPopUp.ActionStatus actionStatus) {
        try {
            FXMLLoader fxmlMain = new FXMLLoader(Vetor.class.getResource("/mspm/ActionStatusPopUp.fxml"));
