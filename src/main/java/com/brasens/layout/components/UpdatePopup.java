...
public class UpdatePopup extends AnchorPane {
    ...
    private Color backgroundButtonColor = Color.web("#0b1727"); //#3c5999
    ...
    public void render(){
        ...
        ImageView updateImage = new ImageView(
                new Image(Vetor.class.getResource("/Vetor/icons/default/rocket-lunch.png").toString())
        );
        ...
        updateButton = new CustomButton(
                "Update",
                new Image(Vetor.class.getResource("/Vetor/icons/download.png").toString()),
            ...
            final Animation animation = new Transition() {
                ...
                protected void interpolate(double frac) {
                    ...
                    updateButton.getButtonLabelImageView().setImage(
                            ImageUtils.colorizeImage(new Image(Vetor.class.getResource("/Vetor/icons/download.png").toString()),imageColor)
                    );
    ...
    public void downloadUpdate(){
        if (Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(Desktop.Action.BROWSE)) {
            try {
                File downloadedUpdate = new File(FilesManager.ApplicationDataFolder + "\\" + "updates" + "\\" + "Brasens Vetor.exe");
